...
export class PendingCompetitionsListComponent implements OnInit, OnDestroy
{
...
customerId : any;
    ...
    ngOnInit(): void
    {
        if(this.route.snapshot.paramMap.get('id')){
            ...
            this.getAllPendingCompetitionsByCustomerId(this.customerId)

        }else{
            this.getAllPendingCompetitions()
        }
    ...
    getAllPendingCompetitions() {
        this.competitionService.getAllPendingCompetitions().subscribe(
            (data) => {
                console.log(data)
    ...
    getAllPendingCompetitionsByCustomerId(customerId:any) {
        this.usersService.getCustomerPendingCompetitions(customerId).subscribe(
            (data) => {
                console.log(data)
                this.competitions=data
                for (let i = 0; i < this.competitions.length; i++) {
